...
namespace Proyecto1_MZ_MJ.Controllers
{
    public class ComentariosController : Controller
    {
        ...
        public ComentariosController(Proyecto1_MZ_MJContext context)
        {
            _context = context;
        }
        ...
        {
            var proyecto1_MZ_MJContext = _context.Comentario.Include(c => c.Habitacion);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Proyecto1_MZ_MJContext.Comentario'  is null.");
            }
            var comentario = await _context.Comentario.FindAsync(id);
            if (comentario != null)
            {
