...
using Proyecto1_MZ_MJ.Models; // Añadido para CollectionPoint
using Proyecto1_MZ_MJ.Services; // Añadido para DistanceCalculator
...
namespace Proyecto1_MZ_MJ.Controllers
{
    ...
    public class DistanceController : ControllerBase
    {
        ...
        public DistanceController(Proyecto1_MZ_MJContext context)
        {
            _context = context;
        }
